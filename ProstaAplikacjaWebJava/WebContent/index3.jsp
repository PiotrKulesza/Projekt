	...
	<div class="wraper">
			<nav class="menu">
				<div class="menu-center">
					...
					<a href="${str }"><img src="images/ikona grupy.png" alt="Error" width="80px" height="80px"/></a>
					<a href="${str }"><img src="images/ikona przedmioty.png" alt="Error" width="80px" height="80px"/></a>
					<a href="${str }"><img src="images/ikona sprawozdania.png" alt="Error" width="80px" height="80px"/></a>
					<a href="${str }"><img src="images/ikona studenci.png" alt="Error" width="80px" height="80px"/></a>
		...
		<form action="Logout">
			<input class="center-block2" type="image" src="images/logk.png" alt="Wyloguj">
		</form>
